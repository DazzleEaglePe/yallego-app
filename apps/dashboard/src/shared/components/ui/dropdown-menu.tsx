...
>(({ className, sideOffset = 8, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      className={cn(
        'z-50 min-w-56 overflow-hidden rounded-xl border border-neutral-200 bg-white p-1.5 text-neutral-950 shadow-[0_18px_50px_rgba(15,23,42,0.16)] outline-none',
...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Label
    className={cn(
      'px-2.5 py-2 text-[10px] font-semibold uppercase tracking-[0.14em] text-neutral-400',
      className,
    )}
    ref={ref}
    {...props}
